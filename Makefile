...
windowU: xdotool.apt wmctrl.apt
...
bolker: merTools.cran rbenchmark.cran optparse.cran sf.cran tmap.cran
plague: tinytest.cran tinysnapshot.cran odin.cran
odin.cran: dde.cran
...
qmee: tinyplot.cran ratdat.cran dotwhisker.rsource see.cran equatiomatic.rsource gllvm.cran skimr.cran ordinalsim.rgit sure.cran geomorph.cran pwr.cran ggExtra.cran
...
qmee_students_old: unmarked.cran randomForest.cran pacman.cran EnvStats.cran lsr.cran coefplot.cran qqplotr.cran
